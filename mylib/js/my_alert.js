...
$().ready(function () {
	$("body").append('<div class="modal fade" id="my_alert_modal" data-backdrop = "static"><div style="position:absolute;width:100%;height:100%;display: flex;justify-content: center;align-items: center;"><div id="my_alert_div" class="alert alert-warning alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><p>111</p></div></div></div>');
